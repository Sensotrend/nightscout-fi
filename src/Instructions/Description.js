  ...
  render() {
    return (
      <Fragment>
        ...
        <p>Nightscout Connect -palvelun avulla Nightscout-sovellukset kytkeytyvät suoraan Kanta-palveluihin
          kuuluvaan <a href="https://www.kanta.fi/web/guest/hyvinvointitiedot">Omatietovarantoon</a>.</p>
        <p>Omatietovarantoon tallennettu tieto on aina täysin kansalaisen itsensä hallinnoitavissa. Sinä
          itse päätät, mitkä tahot ja sovellukset pääsevät käsiksi tietoihisi.
        </p>
        <p>Lähitulevaisuudessa pääset tutkimaan Omatietovarantoon tallennettuja tietoja eri sovellusten
