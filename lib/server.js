...
import CarelinkService from './carelinkService';
...
app.get('/logout', (req, res) => {
   ...
   StateInformation.findOneAndDelete(
      {
...
<<<<<<< HEAD
=======
>>>>>>> Add new crypto, new carelink site, new carelink backend changes  and make changes configuration for eslint and mongo.
let carelinkService = CarelinkService(env);

app.use('/carelink', carelinkService);

env.logger.info('Carelink Service started');

<<<<<<< HEAD
=======
>>>>>>> Revert "Continue enabling SSL on localhost"
=======
>>>>>>> Add new crypto, new carelink site, new carelink backend changes  and make changes configuration for eslint and mongo.
//production mode
if (process.env.NODE_ENV === 'production') {
