...
const NSCONSENT_BASE_URL = process.env.NSCONSENT_BASE_URL ? process.env.NSCONSENT_BASE_URL : 'https://localhost:1300/nsconsent';
   ...
   app.post('/grantpermission', async (req, res) => {
      ...
      if (req.body.secret && req.body.url) {
         ...
         try {
            ...
            logger.error('Error connecting to Nightscout ' +  error);
         }
      }
