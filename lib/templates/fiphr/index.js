...
function FIPHRDataProcessor () {
   ...
   function enrichFHIRObject (sourceData) {
      ...
      entry._timezoneOffset = d.getTimezoneOffset() * -1;
   ...
   function enrichObject (sourceData, patientReference) {
      ...
      entry.time_fhir = moment(sourceData.time).utcOffset(sourceData.timezoneOffset, true).toISOString(true); //.format('YYYY-MM-DDTHH:mm:ssZ');
